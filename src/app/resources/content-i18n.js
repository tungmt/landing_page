            ...
            institutions: [
                {
                    ...
                    description: <>{t(`about.studies.institutions.Hanoi University of Science and Technology.description`)}</>,
                }
            ]
        },
        technical: {
            ...
            skills: [
                {
                    title: 'React-Native',
                    description: <>{t("about.technical.skills.React-Native.description")}</>,
                    images: [
                        {
                ...
                {
                    title: 'Backend',
                    description: <>{t("about.technical.skills.Backend.description")}</>, // "." not accepted in next-intl namespace
                    images: [
                        {
